...
fetch -o /usr/local/pkg -q https://github.com/kingdomp/pf2ad/blob/main/samba.inc
fetch -o /usr/local/pkg -q https://github.com/kingdomp/pf2ad/blob/main/samba.xml
